...
1. **Sichao Fu**, Weifeng Liu, Weili Guan, Yicong Zhou, Dapeng Tao and Changsheng Xu, "Dynamic Graph Learning Convolutional Networks for Semi-supervised Classification", **ACM Transactions on Multimedia Computing Communications and Applications**, in press, 2020.
1. Weifeng Liu (Supervisor), **Sichao Fu**,  Yicong Zhou, Zheng-Jun Zha and Liqiang Nie, ["Human Activity Recognition by Manifold Regularization Based Dynamic Graph Convolutional Networks"](https://doi.org/10.1016/j.neucom.2019.12.150), **Neurocomputing**, accepted, 2020.
