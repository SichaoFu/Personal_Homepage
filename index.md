...
1. Yuetian Wang (Co-supervised Student), **Sichao Fu** (Corresponding Author), Qinmu Peng, Bin Zou, Xiao-Yuan Jing and Xinge You. Multi-view Interaction Graph Convolutional Neural Network for Semi-supervised Classification. **Journal of Software**, in press, 2023. (In Chinese) // [URL]()
