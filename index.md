...
### Journals
1. **Sichao Fu**, Baodi Liu, Weifeng Liu, Bin Zou, Xinhua You, Qinmu Peng and Xiao-Yuan Jing, " Adaptive Multi-scale Transductive Information Propagation for Few-shot Learning", **IEEE Transactions on Industrial Informatics**, Under Review. 
1. **Sichao Fu**, Senlin Wang, Weifeng Liu, Baodi Liu, Xinhua You, Xiao-Yuan Jing and Xinge You, "Attention-guided Adaptive Graph Convolutional Networks for Semi-supervised Classification", **IEEE/CAA Journal of Automatica Sinica**, Under Review. 
