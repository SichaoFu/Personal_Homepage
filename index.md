...
1. Wuli Wang (Co-advisor), Yun Liu (Co-supervised Student), Qi Sun, **Sichao Fu** (Co-corresponding Author), Jianbu Wang, Baodi Liu and Peng Ren. Adaptive Decision Boundary Learning with Class-balanced Pseudo-labelling for Open-set Semi-supervised Hyperspectral Image Classification. **Chinese Journal of Electronics**, in press, 2026. // [URL]()
