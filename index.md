...
1. Yu Song (Co-supervised Student), **Sichao Fu** (Co-first Author), Hongquan Xin, Wuli Wang, Peng Ren, Baodi Liu and Weihua Ou. XXX. **IEEE Transactions on Multimedia**, Under Review.
...
1. Yuanjun Yang (Co-supervised Student), Weihua Ou (Co-advisor), **Sichao Fu** (Co-corresponding Author), Jiaming Chen and Yunshun Wu. Heterogeneous Graph Completion Collaborative Network for Attribute-missing Heterogeneous Graph Representation Learning. **Expert Systems with Applications**, Article 128402, 2025. // [URL](https://doi.org/10.1016/j.eswa.2025.128402)
